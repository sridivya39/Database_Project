...
<div id="login" style="position: relative;" class="container surface p-3 mb-5 rounded">
        ...
        <h3 class="header-title">SIGN UP HERE!</h3>
        <h3 class="header-title">Click the button on the right to register!</h3>
        ...
        <div class="modal-content">
            ...
            <?php
                ...
                ?> 
                    ...
                    <button type="submit" name="submit" class="btn btn-block btn-primary" onclick="window.location.href='/sridivyamajeti/Ice-cream%20Shop%20template/firstpage.php'">Sign Up!</button>
                    <button type="submit" name="submit" class="btn btn-block btn-primary" onclick="window.location.href='/sridivyamajeti/Ice-cream%20Shop%20template/login.php'">Login</button>
                </form>
            </div>
