   ...
   <table>
      ...
      <tbody>
         ...
         <td><?php echo $row['RatingID']; ?></td>
            ...
            <td><?php echo $row['IcecreamID']; ?></td>
            <td><?php echo $row['Comment']; ?></td>
            <td><?php echo $row['RatingScore']; ?></td>
            <td>
            <a href="viewrating.php?delete=<?php echo $row['RatingID']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
