...
<?php
                ...
                $delete_query = mysqli_query($conn, "DELETE FROM PAYMENT WHERE PaymentID = $payment_id ") or die('query failed');
                if($delete_query){
                    header('location:vieworders.php');
                    $message[] = 'Order history has been deleted';
                }else{
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM PAYMENT");
         ...
         <td><?php echo $row['CustomerID']; ?></td>
            ...
            <td>
            <a href="vieworders.php?delete=<?php echo $row['PaymentID']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
